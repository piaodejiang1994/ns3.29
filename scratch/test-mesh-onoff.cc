...
/*  UdpEchoServerHelper echoServer (9);
  ...
  UdpEchoClientHelper echoClient (interfaces.GetAddress (12), 9);
  ...
  int port = 9;
	...
	//clientHelper2.SetAttribute ("PacketSize", UintegerValue (m_packetSize));

	clientHelper1.SetAttribute ("DataRate", DataRateValue (DataRate ("6Mb/s")));
	//clientHelper2.SetAttribute ("DataRate", DataRateValue (DataRate ("6Mb/s")));
